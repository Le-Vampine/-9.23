# -*- coding: utf-8 -*-
r"""S2：片段级时间重要性的梯度类来源（注意力 / 积分梯度 / 注意力×梯度）。

三个来源（论文 §5.3 的 (a)(b) 两族）：
  (a) 注意力源           w^att_k = alpha_k                        （模型内生，仅作基线）
  (a') 注意力×梯度源      w^agrad_k = alpha_k · ||∂t/∂x_k||_2       （Grad-CAM 式加权）
  (b) 积分梯度            w^ig_k = ||(x_k - x'_k) ⊙ (1/L)Σ_l ∇_{x_k} t(x' + l/L(x-x'))||_2
